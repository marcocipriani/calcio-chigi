                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Popover>
                            ...
                            <PopoverContent className="w-48 p-2 flex flex-col gap-1">
                                <Button onClick={downloadImage} variant="ghost" className="justify-start text-xs h-8"><Download className="mr-2 h-3 w-3" /> Scarica Immagine</Button>
                                <Button onClick={downloadExcelDistinta} variant="ghost" className="justify-start text-xs h-8"><FileSpreadsheet className="mr-2 h-3 w-3" /> Scarica Excel</Button>
                                <div className="h-px bg-border my-1" />
                                <Button onClick={() => { setLineup({}); setCaptainId(null); setViceCaptainId(null); }} variant="ghost" className="justify-start text-xs h-8 text-red-600 hover:text-red-700 hover:bg-red-50"><Trash2 className="mr-2 h-3 w-3" /> Reset Campo</Button>
                            </PopoverContent>
                        </Popover>
                    </div>
                </div>
