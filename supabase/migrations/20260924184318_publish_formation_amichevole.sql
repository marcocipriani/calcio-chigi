...
-- u35_squad_quota_five (applicata in parallelo) ha ricreato la funzione dalla
-- versione precedente, perdendo AMICHEVOLE di events_amichevole_places.
-- Qui: quota U35 a 5 + amichevoli con tesserati TRAINING_ONLY.
...
begin
  ...
  if u35_field_count > 3 or u35_total_count > 5 then
