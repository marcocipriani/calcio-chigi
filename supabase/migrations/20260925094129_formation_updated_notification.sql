-- Ora il manager può modificare una formazione già pubblicata: la ripubblicazione
-- notifica "Formazione aggiornata" invece di ripetere "pubblicata".
-- Corpo identico a amichevole_no_u35_quota salvo was_published e i testi.
...
begin
  ...
  perform public.create_notification(
    ...
    case when was_published
      then 'Formazione aggiornata'
